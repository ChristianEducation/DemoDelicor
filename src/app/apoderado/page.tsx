    ...
    <PortalShell step={1}>
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1.15fr] lg:items-center lg:gap-16">
        <div className="hidden lg:block">
          ...
          <h1 className="display-font mt-2 text-[2.35rem] font-bold leading-[1.08] tracking-[-0.02em]">
            Reserva y paga el almuerzo de tu hijo o hija
          </h1>
          <p className="mt-4 max-w-sm text-lg text-[var(--muted)]">
            Selecciona el colegio, el curso y el estudiante para ver la minuta de la semana.
          </p>
        </div>
