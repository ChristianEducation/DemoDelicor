  ...
  return (
    <>
      <button
        ref={btnRef}
        type="button"
        className="inline-grid size-5 shrink-0 place-items-center rounded-full border border-[var(--line)] bg-[var(--paper)] text-[var(--muted)] transition-colors hover:border-[var(--coral)] hover:text-[var(--coral)]"
        aria-expanded={open}
