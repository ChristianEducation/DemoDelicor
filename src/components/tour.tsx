  ...
  return createPortal(
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <span className="text-[0.65rem] font-extrabold uppercase tracking-[0.08em] text-[var(--coral)]">
          {index + 1} de {steps.length}
        </span>
        <button
          type="button"
          className="grid size-7 place-items-center rounded-lg text-[var(--muted)] hover:bg-[var(--ink-soft)]"
          onClick={close}
